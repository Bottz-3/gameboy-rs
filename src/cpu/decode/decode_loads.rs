...
impl Cpu {
    pub fn decode_loads(&mut self, opcode: u8) -> u32 {
        match opcode {
            0x40 => {
                self.registers.load_register(Register::B, Register::B);
                4
            }
            0x50 => {
                self.registers.load_register(Register::D, Register::B);
                4
            }
            0x60 => {
                self.registers.load_register(Register::H, Register::B);
                4
            }
            0x70 => {
            ...
            0x41 => {
                self.registers.load_register(Register::B, Register::C);
                4
            }
            0x51 => {
                self.registers.load_register(Register::D, Register::C);
                4
            }
            0x61 => {
